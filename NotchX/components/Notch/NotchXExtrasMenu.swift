...
struct NotchXLargeButtons: View {
    var action: () -> Void
    var icon: Image
    var title: String
    var body: some View {
...
struct NotchXExtrasMenu : View {
    @ObservedObject var vm: NotchXViewModel
    ...
    var github: some View {
        NotchXLargeButtons(
            action: {
                if let url = URL(string: "https://github.com/MarvinBarsal/NotchX") {
