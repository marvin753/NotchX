...
final class XPCHelperClient: NSObject {
    ...
    private let serviceName = "marvinbarsal.notchx.NotchXXPCHelper"
    
    private var remoteService: RemoteXPCService<NotchXXPCHelperProtocol>?
    ...
    @MainActor
    private func ensureRemoteService() -> RemoteXPCService<NotchXXPCHelperProtocol> {
        ...
        let service = RemoteXPCService<NotchXXPCHelperProtocol>(
            connection: conn,
            remoteInterface: NotchXXPCHelperProtocol.self
        )
    ...
    @MainActor
    private func getRemoteService() -> RemoteXPCService<NotchXXPCHelperProtocol>? {
        remoteService
    }
