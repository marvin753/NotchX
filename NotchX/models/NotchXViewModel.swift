...
class NotchXViewModel: NSObject, ObservableObject {
    @ObservedObject var coordinator = NotchXViewCoordinator.shared
    @ObservedObject var detector = FullscreenMediaDetector.shared

    let animationLibrary: NotchXAnimations = .init()
    ...
    @Published var isBluetoothPopoverActive: Bool = false
    ...
    func close() {
        ...
        self.isBluetoothPopoverActive = false
