...
extension Defaults.Keys {
    ...
    static let releaseName = Key<String>("releaseName", default: "Marvin Barsal")
    ...
    static let progressBarStyle = Key<ProgressBarStyle>("progressBarStyle", default: .white)
    ...
    // MARK: Shelf
    static let notchXShelf = Key<Bool>("notchXShelf", default: true)
